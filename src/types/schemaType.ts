...
export type IUserDetailResolvers<
  ContextType = any,
  ParentType extends IResolversParentTypes['UserDetail'] = IResolversParentTypes['UserDetail']
> = {
...
export type IShortUrlDetailResolvers<
  ContextType = any,
  ParentType extends IResolversParentTypes['ShortUrlDetail'] = IResolversParentTypes['ShortUrlDetail']
> = {
  _id?: Resolver<IResolversTypes['ID'], ParentType, ContextType>;
...
export type IShortUrlResolvers<
  ContextType = any,
  ParentType extends IResolversParentTypes['ShortUrl'] = IResolversParentTypes['ShortUrl']
> = {
  _id?: Resolver<IResolversTypes['ID'], ParentType, ContextType>;
  originalUrl?: Resolver<IResolversTypes['String'], ParentType, ContextType>;
  shareWith?: Resolver<Maybe<Array<IResolversTypes['User']>>, ParentType, ContextType>;
...
export type ILoginUserRespResolvers<
  ContextType = any,
  ParentType extends IResolversParentTypes['LoginUserResp'] = IResolversParentTypes['LoginUserResp']
> = {
  user?: Resolver<IResolversTypes['User'], ParentType, ContextType>;
  tokens?: Resolver<IResolversTypes['Tokens'], ParentType, ContextType>;
  __isTypeOf?: isTypeOfResolverFn<ParentType>;
...
export type IMeRespResolvers<
  ContextType = any,
  ParentType extends IResolversParentTypes['MeResp'] = IResolversParentTypes['MeResp']
> = {
...
> = {
  ...
  login?: Resolver<
    IResolversTypes['LoginUserResp'],
    ParentType,
    ContextType,
    RequireFields<IQueryLoginArgs, 'emailAddress' | 'password'>
  >;
  expandUrl?: Resolver<
    IResolversTypes['ShortUrlDetail'],
    ParentType,
    ContextType,
    RequireFields<IQueryExpandUrlArgs, '_id'>
  >;
};
...
> = {
  createUser?: Resolver<
    IResolversTypes['CreateUserResp'],
    ParentType,
    ContextType,
    RequireFields<IMutationCreateUserArgs, 'name' | 'emailAddress' | 'password'>
  >;
  shortenUrl?: Resolver<
    IResolversTypes['ShortUrl'],
    ParentType,
    ContextType,
